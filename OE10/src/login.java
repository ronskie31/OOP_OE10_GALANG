...
public class login extends JFrame {
	...
	public login() {
		...
		lblUN.setBounds(325, 122, 92, 26);
		lblUN.setFont(new Font("Agency FB", Font.BOLD, 24));
		lblUN.setForeground(Color.WHITE);
		contentPane.add(lblUN);
		
		JLabel lblP = new JLabel("PASSWORD");
		lblP.setBounds(325, 203, 92, 22);
		lblP.setForeground(Color.WHITE);
		lblP.setFont(new Font("Agency FB", Font.BOLD, 24));
		...
		lblNewLabel.setFont(new Font("Titillium Web Black", Font.BOLD, 25));
		lblNewLabel.setBounds(266, 25, 133, 32);
